    ...
    return <div className="m-2 h-full bg-white">
        <div className='flex items-center justify-between m-2'>
            <label className="relative flex items-center w-2/6">
                ...
                <input className="placeholder:text-slate-400 block bg-gray-100 w-full border rounded-md py-2 pl-9 pr-3 shadow-sm outline-none sm:text-sm h-7" placeholder="Search by Order ID..." type="text" name="search"/>
            </label>
